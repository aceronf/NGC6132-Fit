...
if __name__ == "__main__":
    ...
    cbar.set_label(r"Normalized intensity", fontsize=30)
    cbar.ax.tick_params(labelsize=24)
    ax3.set_xlabel(r"$X$ [pixel]", fontsize=30)
    ax3.set_ylabel(r"$Y$ [pixel]", fontsize=30)
    ...
    cax = ax4.imshow(masked_calibrada , cmap='inferno', origin='lower', aspect="equal",
                     vmax=23, vmin=11)
    cbar = plt.colorbar(cax, ax=ax4)
    cbar.set_label(r"$\mu$ [$\unit{\mag\per\arcsec\squared}$]", fontsize=30)
    cbar.ax.tick_params(labelsize=24)
    ax4.set_xlabel(r"$X$ [pixel] ", fontsize=30)
    ax4.set_ylabel(r"$Y$ [pixel]", fontsize=30)
    ...
    ax5.set_xlabel(r"semi-major axis [pixel] ", fontsize=30)
    ...
    ax6.set_xlabel(r"semi-major axis [$\unit{\arcsec}$] ", fontsize=30)
    ...
    cax = ax8.imshow(resid_exp_cal, cmap='twilight', origin='lower', aspect="equal", extent=[x_extent.min(), x_extent.max(), y_extent.min(), y_extent.max()])

                     
    cbar = plt.colorbar(cax, ax=ax8)
    cbar.set_label(r"$\mu$ / $\unit{\mag\per\arcsec\squared}$", fontsize=30)
    cbar.ax.tick_params(labelsize=24)
    ...
    ax9.set_xlabel(r"semi-major axis [$\unit{\arcsec}$] ", fontsize=30)
    ...
    cax = ax11.imshow(resid_expser_cal, cmap='twilight', origin='lower', aspect="equal", extent=[x_extent.min(), x_extent.max(), y_extent.min(), y_extent.max()],
                      vmin=-40, vmax=40)

                     
    cbar = plt.colorbar(cax, ax=ax11)
    cbar.set_label(r"$\mu$ / $\unit{\mag\per\arcsec\squared}$", fontsize=30)
    cbar.ax.tick_params(labelsize=24)
    ...
    ax12.plot(rr, mu_exp, linestyle="dashdot", color="darkgreen", linewidth=3, alpha=0.8,label=r"Modelo exponencial")
    ax12.plot(rr, mu_sersic, linestyle="dotted", color="darkorange", linewidth=3, alpha=0.8,label=r"Sersic")
    ax12.plot(rr, mu_total, "--", color="black", linewidth=3, alpha=0.9,label=r"Total")
    ax12.set_xlabel(r"semi-major axis [$\unit{\arcsec}$] ", fontsize=30)
    ...
    inset.plot(rr, mu_exp, linestyle="dashdot", color="darkgreen", linewidth=3, alpha=0.8,label=r"Modelo exponencial")
    inset.plot(rr, mu_sersic, linestyle="dotted", color="darkorange", linewidth=3, alpha=0.8,label=r"Sersic")
    ...
    inset.set_xlabel(r"semi-major axis [$\unit{\arcsec}$] ", fontsize=20)
